...
def odstraniUKinNor(drzave):
    ...
    try:
        ...
        drzave.remove('Norway') # unicode error
        drzave.remove('Netherlands') # unicode error
    except:
        pass
...
def pretvori_v_csv(podatki):
    ...
    with open( izbrana_drzava + '\\podatki.txt','w') as csvFile:
        ...
        naslovnaVrstica = 'MESTO,Drzava,drsifra,januar,februar,marec,april,maj,junij,julij,avgust,' \
...
def zazeni_analizaGUI():
    ...
    drzave = odstraniUKinNor(drzavee)
    ...
    return mesec, izbrana_drzava + '\\podatki.txt' , ime_datotekeRazv
